    ...
    <div style={{ 
      ...
      <section id="home" style={{ 
        ...
        <h1 style={{ 
          ...
          Mero Care Card <br />
          <span style={{ 
            background: colors.gradientPrimaryBtnAlt,
      ...
      <section id="about" style={{ scrollMarginTop: '100px' }}>
        <div style={{ 
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1.5rem' }}>
            ...
            <div style={{ 
              padding: '1.5rem', 
              background: colors.successGhostStrong, 
      ...
      <section style={{ margin: '2rem 0' }}>
        <div style={{
          ...
          <p style={{ maxWidth: '600px', margin: '0 auto 2.5rem', color: colors.textSecondary }}>
        ...
        <div style={{ 
          ...
          <div style={{ display: 'flex', flexDirection: 'column', justifyContent: 'space-between', gap: '2rem' }}>
            <div>
              ...
              <p style={{ fontSize: '0.95rem', marginBottom: '1.5rem', color: colors.textSecondary }}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '1.2rem' }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: '1rem' }}>
                ...
                <div>
                  <p style={{ fontSize: '0.75rem', color: colors.textMuted, textTransform: 'uppercase' }}>Email Support</p>
                  <p style={{ color: colors.textPrimary, fontWeight: 600, fontSize: '0.9rem' }}>support@merocarecard.com</p>
                </div>
              </div>
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: '1rem' }}>
                ...
                <div>
                  <p style={{ fontSize: '0.75rem', color: colors.textMuted, textTransform: 'uppercase' }}>Emergency Desk</p>
                  <p style={{ color: colors.textPrimary, fontWeight: 600, fontSize: '0.9rem' }}>+977 (1) 456-7890</p>
                </div>
              </div>
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: '1rem' }}>
                ...
                <div>
                  <p style={{ fontSize: '0.75rem', color: colors.textMuted, textTransform: 'uppercase' }}>Office HQ</p>
                  <p style={{ color: colors.textPrimary, fontWeight: 600, fontSize: '0.9rem' }}>Kathmandu, Nepal</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div>
            ...
            {contactSuccess ? (
              <div style={{
                ...
                <ShieldCheck size={40} style={{ color: colors.secondary, marginBottom: '0.5rem' }} />
                <h4 style={{ color: colors.textPrimary }}>Message Received</h4>
                <p style={{ fontSize: '0.85rem', color: colors.textSecondary }}>Thank you. Our compliance officer will reach back to your email within 1 hour.</p>
              </div>
            ) : (
              <form onSubmit={handleContactSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
                ...
                <div>
                  <label style={{ ...label }}>Message Details</label>
                  <textarea 

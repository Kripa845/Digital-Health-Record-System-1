...
from .models import PatientProfile,  MedicalHistoryEntry,  FamilyMemberProfile, PatientDocument
...
class PatientProfileSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            'recent_pain', 'is_profile_setup', 'qr_token'
        ]
        read_only_fields = ['id', 'healthcare_id', 'qr_token']
...
class RegisterPatientSerializer(serializers.ModelSerializer):
    ...
    def validate(self, attrs):
        ...
        # Check email/username uniqueness manually if provided
        if email:
